...
function embedded_svg_edit(frame) {
  ...
  var functions = ["updateElementFromJson", "embedImage", "fixOperaXML", "clearSelection", "addToSelection",
    "removeFromSelection", "addNodeToSelection", "open", "save", "getSvgString", "setSvgString", "setSvgStringEraser", "createLayer",
    ...
    "setFontSize", "getText", "setTextContent", "notifyTextchange", "addCommandToHistory", "getDOMContainer", "setImageURL", "setRectRadius", "setSegType", "quickClone",
    ...
    "getNextRedoCommandText", "undo", "redo", "cloneSelectedElements", "getSelectedElems", "setCursor", "alignSelectedElements", "getZoom", "getVersion",
    "setIconSize", "setLang", "setCustomHandlers", "updateCanvas", "setFHDBackground", "setBackground", "getFontColor", "setFontColor", "SaveDrawingToMoodle", "getHDQuestionID", "setHDQuestionID", "getElem", "getDOMContainer", "getDOMDocument", "assignAttributes", "transformPoint"];
