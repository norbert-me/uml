...
debug_to_console("version 0.1");
debug_to_console("fhd:" . json_encode($fhd)); //$fhd is an object

//wieso hier wieder auf 0 netzten? was ist $fhd->drawingmode?
$displaystyle = '';
...
<head>
   ...
   <script>
      //print_string is a function from moodle to output a translation
   ...
   <script type="text/javascript" src="<?php echo $CFG->wwwroot . '/question/type/drawing/'; ?>lib/touch.js"></script>
   <script type="text/javascript" src="<?php echo $CFG->wwwroot . '/question/type/drawing/'; ?>lib/js-hotkeys/jquery.hotkeys.min.js"></script>
   <script type="text/javascript" src="<?php echo $CFG->wwwroot . '/question/type/drawing/'; ?>icons/jquery.svgicons.js"></script>
   <script type="text/javascript" src="<?php echo $CFG->wwwroot . '/question/type/drawing/'; ?>lib/jgraduate/jquery.jgraduate.js"></script>
   <script type="text/javascript" src="<?php echo $CFG->wwwroot . '/question/type/drawing/'; ?>lib/contextmenu/jquery.contextMenu.js"></script>
   <script type="text/javascript" src="<?php echo $CFG->wwwroot . '/question/type/drawing/'; ?>lib/jquery-ui/jquery-ui-1.8.17.custom.min.js"></script>
   <script type="text/javascript" src="<?php echo $CFG->wwwroot . '/question/type/drawing/'; ?>src/browser.js"></script>
   <script type="text/javascript" src="<?php echo $CFG->wwwroot . '/question/type/drawing/'; ?>src/svgtransformlist.js"></script>
   <script type="text/javascript" src="<?php echo $CFG->wwwroot . '/question/type/drawing/'; ?>src/math.js"></script>
   <script type="text/javascript" src="<?php echo $CFG->wwwroot . '/question/type/drawing/'; ?>src/units.js"></script>
   <script type="text/javascript" src="<?php echo $CFG->wwwroot . '/question/type/drawing/'; ?>src/svgutils.js"></script>
   <script type="text/javascript" src="<?php echo $CFG->wwwroot . '/question/type/drawing/'; ?>src/sanitize.js"></script>
   ...
   <script type="text/javascript" src="<?php echo $CFG->wwwroot . '/question/type/drawing/'; ?>src/method-draw.js"></script>
   <script type="text/javascript" src="<?php echo $CFG->wwwroot . '/question/type/drawing/'; ?>lib/jquery-draginput.js"></script>
   <script type="text/javascript" src="<?php echo $CFG->wwwroot . '/question/type/drawing/'; ?>lib/contextmenu.js"></script>
   <script type="text/javascript" src="<?php echo $CFG->wwwroot . '/question/type/drawing/'; ?>lib/jgraduate/jpicker.min.js"></script>
   <script type="text/javascript" src="<?php echo $CFG->wwwroot . '/question/type/drawing/'; ?>lib/mousewheel.js"></script>
   <?php
   if ($reducedmode == 0) {
   ?>
      <script type="text/javascript" src="<?php echo $CFG->wwwroot . '/question/type/drawing/'; ?>extensions/ext-eyedropper.js"></script>
   <?php
   }
   ?>
   <script src="<?php echo $CFG->wwwroot . '/question/type/drawing/'; ?>src/d3.js"></script>
   <script type="text/javascript" src="<?php echo $CFG->wwwroot . '/question/type/drawing/'; ?>extensions/mtouch-events.js"></script>
   <?php
   if ($fhd->allowerase == 1) {
   ?>
      <script type="text/javascript" src="<?php echo $CFG->wwwroot . '/question/type/drawing/'; ?>extensions/erase.js"></script>
      <script type="text/javascript" src="<?php echo $CFG->wwwroot . '/question/type/drawing/'; ?>extensions/ext-eraser.js"></script>
      <script type="text/javascript" src="<?php echo $CFG->wwwroot . '/question/type/drawing/'; ?>src/flatten.js"></script>
      <script type="text/javascript" src="<?php echo $CFG->wwwroot . '/question/type/drawing/'; ?>src/flat.js"></script>
   <?php
   }
   ?>
   <script type="text/javascript" src="<?php echo $CFG->wwwroot . '/question/type/drawing/'; ?>src/simplify.js"></script>
   <?php
   if ($reducedmode == 0) {
   ?>
      <script type="text/javascript" src="<?php echo $CFG->wwwroot . '/question/type/drawing/'; ?>extensions/ext-shapes.js"></script>
   <?php
   }
   ?>
   <script type="text/javascript" src="<?php echo $CFG->wwwroot . '/question/type/drawing/'; ?>extensions/ext-grid.js"></script>
   <script type="text/javascript" src="<?php echo $CFG->wwwroot . '/question/type/drawing/'; ?>lib/requestanimationframe.js"></script>
   <script type="text/javascript" src="<?php echo $CFG->wwwroot . '/question/type/drawing/'; ?>lib/taphold.js"></script>
   <script type="text/javascript" src="<?php echo $CFG->wwwroot . '/question/type/drawing/'; ?>lib/filesaver.js"></script>
...
<body>
   <div id="svg_editor">
      ...
      <div id="workarea" style="touch-action:none;">
         <div id="svgcanvas" style="position:relative"> <!-- canvas -->
         </div>
      </div>
      <?php
      if ($reducedmode == 0) { //show menubar, when not in recuded mode
      ?>
         <div id="menu_bar">
            <a class="menu">
               <div class="menu_list">
            ...
            <div class="menu">
               ...
               <div class="menu_list" id="edit_menu">
                  <div class="separator"></div>
                  <div class="menu_item action_selected disabled" id="tool_cut"><?php print_string('cut', 'qtype_drawing'); ?> <span class="shortcut">⌘X</span></div>
                  <div class="menu_item action_selected disabled" id="tool_copy"><?php print_string('copy', 'qtype_drawing'); ?> <span class="shortcut">⌘C</span></div>
                  <div class="menu_item action_selected disabled" id="tool_paste"><?php print_string('paste', 'qtype_drawing'); ?> <span class="shortcut">⌘V</span></div>
                  <div class="menu_item action_selected disabled" id="tool_clone"><?php print_string('duplicate', 'qtype_drawing'); ?> <span class="shortcut">⌘D</span></div>
                  <div class="menu_item action_selected disabled" id="tool_delete"><?php print_string('delete', 'qtype_drawing'); ?> <span>⌫</span></div>
               </div>
            </div>
            <div class="menu">
               <div class="menu_title"><?php print_string('object', 'qtype_drawing'); ?></div>
               <div class="menu_list" id="object_menu">
                  <div class="menu_item action_selected disabled" id="tool_move_top"><?php print_string('bringtofront', 'qtype_drawing'); ?>
                     <span class="shortcut">⌘⇧↑</span>
                  </div>
                  <div class="menu_item action_selected disabled" id="tool_move_up"><?php print_string('bringforward', 'qtype_drawing'); ?>
                     <span class="shortcut">⌘↑</span>
                  </div>
                  <div class="menu_item action_selected disabled" id="tool_move_down"><?php print_string('sendbackward', 'qtype_drawing'); ?>
                     <span class="shortcut">⌘↓</span>
                  </div>
                  <div class="menu_item action_selected disabled" id="tool_move_bottom"><?php print_string('sendtoback', 'qtype_drawing'); ?>
                     <span class="shortcut">⌘⇧↓</span>
                  </div>
                  <div class="separator"></div>
                  <div class="menu_item action_multi_selected disabled" id="tool_group"><?php print_string('groupelements', 'qtype_drawing'); ?>
                     <span class="shortcut">⌘G</span>
                  </div>
                  <div class="menu_item action_group_selected disabled" id="tool_ungroup"><?php print_string('ungroupelements', 'qtype_drawing'); ?>
                     <span class="shortcut">⌘⇧G</span>
                  </div>
            ...
            <div class="menu">
               ...
               <div class="menu_list" id="view_menu">
                  ...
                  <div class="separator"></div>
                  <div class="menu_item" id="tool_source"><?php print_string('source', 'qtype_drawing'); ?> <span class="shortcut">⌘U</span></div>
               </div>
            </div>
         </div>
      <?php
      ...
      <div id="tools_top" class="tools_panel">
         <?php if ($useupdateannotationjs == 1) { ?>
            <div id="annotation_panel" class="context_panelv">
               ...
               <div class="annotation_tool draginput" style="width:145px;padding-bottom:2px; height:100%" id="annotation_tool">
                  ...
                  <div id="teacherannotations" style="margin-top:10px;
                              color: #4F80FF;
                              font-size:12px;
                              margin-left:-20px;
                              margin-right:1px;
         ...
         <div id="canvas_panel" class="context_panel">
            ...
            <div class="stroke_tool draginput" style="width:145px;padding-bottom:2px; height:100%" id="fastcolorpicks">
               ...
               <div style="margin-top:15px; text-align:center;">
                  ...
                  <div id="qtype_drawing_tool_color3" class="qtype_drawing_color_divsquare qtype_drawing_selectedcolor" data-strokeorfill="stroke" style="background:#000000"> </div>
                  <div id="qtype_drawing_tool_color4" class="qtype_drawing_color_divsquare" data-strokeorfill="stroke" style="background:#333399"> </div>
                  <div id="qtype_drawing_tool_color5" class="qtype_drawing_color_divsquare" data-strokeorfill="stroke" style="background:#ffff00"> </div>
                  <div id="qtype_drawing_tool_color6" class="qtype_drawing_color_divsquare" data-strokeorfill="stroke" style="background:#00ff00"> </div>
                  <div id="qtype_drawing_tool_color7" class="qtype_drawing_color_divsquare" data-strokeorfill="stroke" style="background:#336633"> </div>
                  <div id="qtype_drawing_tool_color8" class="qtype_drawing_color_divsquare" data-strokeorfill="stroke" style="background:#33cccc"> </div>
                  ...
                  <div id="qtype_drawing_tool_color14" class="qtype_drawing_color_pallette" data-strokeorfill="stroke">
                     <img src="images/colors.png" width="22" height="22" alt="C">
                  </div>
                  <div id="qtype_drawing_tool_color15" class="qtype_drawing_color_pallette" data-strokeorfill="fill">
                     <img src="images/paintbucket.png" width="22" height="22" alt="B">
                  </div>
               </div>
            </div>
            <!-- Penicil size-->
            <div class="stroke_tool draginput" id="preset_sizes_panel_id" style="width:125px;padding:10px; height:70px">
               ...
               <div>
                  <div id="qtype_drawing_tool_pensize1" class="qtype_drawing_size_pen" data-size="1.5" data-penortext="pen" title="1px">
                     <div class="circleBase type1"></div>
                  </div>
                  <div id="qtype_drawing_tool_pensize2" class="qtype_drawing_size_pen" data-size="2.5" data-penortext="pen" title="2px">
                     <div class="circleBase type2"></div>
                  </div>
                  <div id="qtype_drawing_tool_pensize3" class="qtype_drawing_size_pen" data-size="3.5" data-penortext="pen" title="3px">
                     <div class="circleBase type3 qtype_drawing_active_selection"></div>
                  </div>
                  <div style='clear:both'></div>
                  <div id="qtype_drawing_tool_pensize4" class="qtype_drawing_size_pen" data-size="5" data-penortext="pen" title="5px">
                     <div class="circleBase type4"></div>
                  </div>
                  <div id="qtype_drawing_tool_pensize5" class="qtype_drawing_size_pen" data-size="10" data-penortext="pen" title="10px">
                     <div class="circleBase type5"></div>
                  </div>
                  <div id="qtype_drawing_tool_pensize6" class="qtype_drawing_size_pen" data-size="20" data-penortext="pen" title="20px">
            ...
            <div id="stroke_panel" class=" clearfix">
               <div class="clearfix"></div>
               <!--<div class="toolset" data-title="<?php //print_string('changestroke', 'qtype_drawing');
                                                      ?>" id="strokewidth_div">
                  <label>
                  <input id="stroke_width"  type="number" size="2" value="5" data-attr="stroke-width" min="1" max="99" step="1"/>
                  <span class="icon_label"><?php //print_string('strokewidth', 'qtype_drawing');
                                             ?></span>
                  </label>
               </div>-->
         ...
         <div id="selected_panel" class="context_panel">
            ...
            <?php } ?>
            <label id="tool_angle" data-title="<?php print_string('changerotationangle', 'qtype_drawing'); ?>" class="draginput" <?php echo $displaystylefull; ?>>
            ...
            <div class="toolset" id="tool_blur" data-title="<?php print_string('changeblur', 'qtype_drawing'); ?>" <?php echo $displaystylefull; ?>>
               <label>
            ...
            <label id="cornerRadiusLabel" data-title="<?php print_string('changecornerradius', 'qtype_drawing'); ?>" <?php echo $displaystylefull; ?>>
         ...
         <div id="path_node_panel" class="context_panel clearfix">
            ...
            <div class="clearfix"></div>
            <div class="tool_button" id="tool_node_clone" title="Adds a node"><?php print_string('addnode', 'qtype_drawing'); ?></div>
            <div class="tool_button" id="tool_node_delete" title="Delete Node"><?php print_string('deletenode', 'qtype_drawing'); ?></div>
            <div class="tool_button" id="tool_openclose_path" title="Open/close sub-path"><?php print_string('openpath', 'qtype_drawing'); ?></div>
         </div>
            ...
            <div class="toolset align_buttons" style="position: relative">
               <label id="tool_align_relative" style="margin-top: 10px;">
                  <select id="align_relative_to" title="Align relative to ...">
                     <option id="selected_objects" value="selected"><?php print_string('aligntoobjects', 'qtype_drawing'); ?></option>
         ...
         <div id="color_tools" <?php
            ...
            <div class="color_tool" id="tool_stroke">
               ...
               <div class="color_block">
                  ...
                  <div id="stroke_color" class="color_block" title="<?php print_string('changestrokecolor', 'qtype_drawing'); ?>"></div>
               </div>
            </div>
         </div>
         <div class="tool_button" id="tool_zoom" title="<?php print_string('zoomtool', 'qtype_drawing'); ?>" style="display:none;"></div>
         <div class="tool_button" id="tool_undo" style="background:#2f2f2c"><img src="images/undo.svg" width="30" height="30"></div>
         <div class="tool_button" id="tool_redo" style="background:#2f2f2c"><img src="images/redo.svg" width="30" height="30"></div>
      </div>
      <!-- tools_left -->
   ...
   <?php if ($reducedmode == 0) { ?>
      <ul id="cmenu_canvas" class="contextMenu">
         ...
         <li class="separator">
            <a href="#delete"><?php print_string('delete', 'qtype_drawing'); ?><span class="shortcut">⌫</span></a>
         </li>
         <li class="separator">
            <a href="#group"><?php print_string('group', 'qtype_drawing'); ?><span class="shortcut">⌘G</span></a>
         </li>
...
<script>
   methodDraw.ready(function() {
      ...
      if (methodDraw.lastanswer && 0 !== methodDraw.lastanswer.length) {
         ...
         console.log("loading answer from lastanswer");
      }
