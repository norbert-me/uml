  ...
  return {
    ...
    mouseDown: function (opts) {
      ...
      if (mode == "eyedropper" && target) {
        ...
        //stroke
        methodDraw.paintBox['stroke'].setPaint(currentStyle.strokePaint);
        svgCanvas.setColor('stroke', currentStyle.strokePaint, true);
        //fill
        methodDraw.paintBox['fill'].setPaint(currentStyle.fillPaint);
        svgCanvas.setColor('fill', currentStyle.fillPaint, true);
        //Text too!
        svgCanvas.setFontColor(currentStyle.strokePaint);
